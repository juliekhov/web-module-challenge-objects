...
// call / invoke the function 3 times, each with different arguments.
// assign the object to a variable name I choose.

const miniTacos = createMenuItem("minitacos", 3, "appetizer");
const salad = createMenuItem("salad", 6, "appetizer");
const wings = createMenuItem("wings", 9, "dinner");
...
burger.discountPrice(clientType) {
    // Simple conditional statement can be put into a ternary operator
    // do i need to use the "this" keyword because i'm accessing price inside object while in burger method?  
    clientType == "teacher" || clientType == "student" ? price = 0.75 * this.price : price = 0.9 * this.price;
...
reviews[8] = { name: "Julie", rating: 4, feedback: "I love minitacos with extra cheese" };
